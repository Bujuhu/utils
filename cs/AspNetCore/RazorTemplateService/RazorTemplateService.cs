...
namespace Utils
{
    public class RazorTemplateService : IRazorTemplateService
    {
        ...
        public RazorTemplateService(IRazorViewEngine viewEngine, IServiceProvider serviceProvider, ITempDataProvider tempDataProvider)
        {
    ...
    public class TemplateServiceException : Exception
    {
        ...
        public TemplateServiceException() :base() {}
